...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "news-paper-accepted-at-wacv-2025-cl-mae-curriculum-learned-masked-autoencoders",
          title: 'Paper accepted at WACV 2025 CL-MAE: Curriculum-Learned Masked Autoencoders',
          description: "",
          section: "News",},{id: "news-honored-to-recieve-spar-nord-forskning-priz-2024-for-outstanding-research-during-my-phd",
          title: 'Honored to recieve Spar Nord Forskning Priz 2024 for outstanding research during my...',
          description: "",
          section: "News",},{id: "news-invited-talk-on-anomaly-detection-in-videos-at-linkoping-university",
          title: 'Invited talk on Anomaly Detection in Videos at Linkoping University',
          description: "",
          section: "News",},{id: "news-honored-to-be-nominated-as-årets-ildsjæl-at-aalborg-awards-2024",
          title: 'Honored to be nominated as Årets Ildsjæl at Aalborg Awards 2024',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%65%6D%61@%63%72%65%61%74%65.%61%61%75.%64%6B", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/NeeluMadan", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/neelu-madan-27357a28", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-5778-3470", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=tIn34swAAAAJ", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
